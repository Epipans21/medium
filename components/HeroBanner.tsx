...
export default function HomeBanner() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#858585] px-4 py-10">
      <div className="w-full max-w-[678px] bg-white px-10 sm:px-16 py-14 sm:py-20 flex flex-col gap-4 shadow-sm">

        <h1 className="text-2xl text-black text-center mb-2 font-serif italic">
          Welcome back.
        </h1>

        <div className="flex flex-col items-center gap-3">

          <button className="w-[85%] flex items-center gap-3 border border-black rounded-full py-3 px-4 text-sm text-black hover:border-black transition">
          ...
          <button className="w-[85%] flex items-center gap-3 border border-black rounded-full py-3 px-4 text-sm text-black hover:border-black transition">
            ...
            <span className="flex-1 text-center">Sign in with X</span>
          </button>
        ...
        <label className="flex items-center justify-center gap-2 text-xs text-gray-600 mt-2">
          <input type="checkbox" className="accent-black w-4 h-4" />
          Remember me for faster sign in
        </label>

        <div className="text-xs text-gray-500 text-center mt-3 space-y-2">
          <p>
            No account? <span className="text-black underline cursor-pointer">Create one</span>
          </p>
          <p>
            Forgot email or trouble signing in?{" "}
            <span className="text-black underline cursor-pointer">Get help.</span>
          </p>
        </div>
